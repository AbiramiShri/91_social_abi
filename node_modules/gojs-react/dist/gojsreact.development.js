...
(function (global, factory) {
    ...
    (global = global || self, factory(global.goJsReact = {}, global.go, global.React));
        ...
        ReactDiagram.prototype.componentDidMount = function () {
            ...
            diagram.delayInitialization(function () {
                ...
                model.commit(function (m) {
                    m.mergeNodeDataArray(m.cloneDeep(_this.props.nodeDataArray));
                    if (_this.props.linkDataArray !== undefined && m instanceof go.GraphLinksModel) {
                        m.mergeLinkDataArray(m.cloneDeep(_this.props.linkDataArray));
                    }
